...
<head>
    ...
    <title>Pantura - Jalan Asyik Keliling Indonesia</title>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Pantura</a>
            </div>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1 id="homeHeading">Jelajah Indonesia Jadi Lebih Mudah!</h1>
                <hr>
                <p>Takut tersesat ketika berpergian ke Luar Kota? Jangan Khawatir! Pantura adalah Panduan Wisata Nusantara yang akan membantumu menjelajahi seluruh Indonesia dengan mudah</p>
                <a href="#" class="btn btn-primary btn-xl page-scroll">Download Sekarang</a>
            </div>
        </div>
    </header>
